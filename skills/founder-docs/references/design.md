# founder-docs — Design System

> **Claude:** Read this file in full before generating any output. It contains the HTML component library (Part 1–2) and the markdown document templates (Part 3). Use Part 1–2 when generating HTML pages. Use Part 3 when generating `.md` files.

---

# Part 1: HTML Foundation

Every HTML page generated by this skill shares the same CSS foundation.

## CSS Custom Properties

Start every HTML file with this `:root` block. Replace `--primary` / `--primary-rgb` and `--secondary` / `--secondary-rgb` with the project's detected brand colors.
...
# Part 2: HTML Components

Grouped by function. Use any combination across the four generated HTML pages.
...
# Part 3: Markdown Templates

Use these as structural guides when generating the 3 markdown files. Replace `[placeholders]` with actual project data from the discovery phase. **Skip any section that doesn't apply** — not every project has revenue, competitors, or a roadmap.
...
See **[setup.md](./setup.md)** for complete step-by-step setup.

## Strategy & Features

See **[strategy.md](./strategy.md)** for the full strategy document.
